...
add_filter('embed_oembed_html', 'Flynt\\TheContentFix\\wrap_embed_with_div', 10, 3);
function wrap_embed_with_div($html, $url, $attr)
{
    return "<div class=\"responsive-youtube-container\"><div class=\"responsive-youtube-container__inner\">" . $html . "</div></div>";
}
